    ...
    <el-dialog title="修改" :visible.sync="dialogFormVisible" width="30%" >
        <el-form label-width="90px" size="mini">
            ...
            <el-form-item label="温度" >
                <el-input v-model="form.tem" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="湿度" >
                <el-input v-model="form.hum" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="氧气浓度" >
                <el-input v-model="form.oxygas" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="有害气体浓度" >
                <el-input v-model="form.nox" autocomplete="off"></el-input>
            </el-form-item>
