    ...
    <el-dialog title="修改" :visible.sync="dialogFormVisible" width="30%" >
        <el-form label-width="90px" size="mini">
            ...
            <el-form-item label="是否损坏" >
                <el-input v-model="form.damage" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="佩戴者" >
                <el-input v-model="form.wearer" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="佩戴者联系方式" >
